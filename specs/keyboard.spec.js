describe('KEYBOARD.JS', function() {
    ...
    describe('arm() method', function() {
        ...
        it('should add an onclick event listener to every button', function() {
            ...
            const testBtn10 = document.getElementById('fr-emotional-&#x1F697'); // car emoji
            const testBtn11 = document.getElementById('fr-emotional-&#x1F9DF'); // zombi emoji

            const testBtns = [testBtn, testBtn2, testBtn3, testBtn4, testBtn5, testBtn6, 
                testBtn7, testBtn8, testBtn9, testBtn10, testBtn11];
            ...
            expect(keyboard.mountDropdown).toHaveBeenCalled();
            expect(keyboard.mountDropdown).toHaveBeenCalledTimes(2);
            expect(keyboard.writeAux).toHaveBeenCalledWith(testBtn10);
            expect(keyboard.writeAux).toHaveBeenCalledWith(testBtn11);
        })
